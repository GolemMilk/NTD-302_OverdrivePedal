...
The complete Bill of Materials is provided as:

- **bom.csv**

This file lists all components with reference designators matching the PCB silkscreen and schematic.

The BOM can be used for:

- Manual parts sourcing  
...
The complete Gerber data set is provided as:

- **NTD-302.zip**

This file contains all PCB fabrication layers and can be uploaded directly to PCB manufacturers such as:
